      ...
      hover:shadow-2xl hover:outline-2 ">
        ...
        <div className="grid grid-cols-12 ">
            ...
            <div className="col-span-7  flex flex-col justify-center ">
              <div className=""> <span className='font-bold text-xl'>{name} ,  </span> <span className='text-sm font-medium'>{age} </span ><span className='font-medium capitalize'>  {gender[0]} </span></div>
